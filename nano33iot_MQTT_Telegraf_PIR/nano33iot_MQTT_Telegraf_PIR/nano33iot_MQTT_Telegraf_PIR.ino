/**************************************************************************
 ...
 Date: 06/27/2023
 Team07
 Description: This program runs on nano33 connects to wifi and sends some info including
              mac addr and MQTT broker publishes on a specified topic to public.cloud.shiftr.io
...
//const char ssid[31] = "";     //Update with your WiFi SSID
//const char pass[31] = "";     //Update with your WiFi password
const char ssid[31] = "Jon";     //Update with your WiFi SSID
const char pass[31] = "opensesame";     //Update with your WiFi password
//*************************************************************
//*************************************************************
//*************************************************************
...
void setup() {
  ...
  Serial1.begin(115200); delay(500);
  randomSeed(analogRead(A7));
//  sprintf(topicPub, "%s%s%s", "gmu/ece508/", gNumber, "/nano33iot");  //ece508/Gxxxx5678/nano33iot
  strcpy(topicPub_1,"gmu/ece508/Team_07/nano33iot2");
  strcpy(topicPub_2,"gmu/ece508/Team_07/nano33iot2");
